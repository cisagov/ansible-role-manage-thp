...
issue](https://github.com/cisagov/ansible-role-manage-thp/issues) in
...
request](https://github.com/cisagov/ansible-role-manage-thp/pulls), you
...
```console
cd ansible-role-manage-thp
pyenv virtualenv <python_version_to_use> ansible-role-manage-thp
pyenv local ansible-role-manage-thp
